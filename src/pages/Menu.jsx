  ...
  return (
    <>
      <div className="w-full h-full flex flex-col md:flex-row">
        <div className="w-full md:w-3/4 h-full flex flex-col gap-6">
          ...
          <div className="flex justify-center items-center px-4 md:px-0 pb-4">
            <Swiper
              ...
              className="!pl-2 md:!pl-24 rounded-lg"
            >
        ...
        <div className="w-full md:w-1/4 h-full flex flex-col justify-between py-6 px-4">
          <div className="w-full flex justify-center gap-12 mb-4">
            <button>
              <svg
          ...
          <div className="h-auto md:h-4/5 bg-gray-100 backdrop-filter backdrop-blur-sm bg-opacity-70 shadow-md rounded-3xl border border-white p-6 flex flex-col gap-3">
            <div className="flex justify-between">
              <button className="font-black">Overview</button>
              <button className="text-gray-400">Ingredients</button>
            </div>
            <div className="flex flex-col justify-between gap-3 h-full">
              <div className="flex flex-col justify-center md:justify-start gap-4 items-center md:items-start">
                <div className="flex flex-col justify-end relative rounded-xl py-2 w-[45px] h-24">
                  <h1 className="text-gray-500 absolute font-bold text-3xl top-1/2 -translate-y-2/3 right-[-20px]">
                    5.0
                  </h1>
                  <div className="bg-orange-400 h-[80%] rounded-xl flex items-end justify-center pb-1">
                    <svg
                      ...
                      fill="#000000"
                    >
                      <path d="M12 17.27L18.18 21 16.54 13.97 22 9.24l-7.19-.62L12 2 9.19 8.62 2 9.24 7.46 13.97 5.82 21z" />
                    </svg>
                  </div>
                </div>
                <div className="">
              ...
              <h6 className="text-gray-500 font-thin text-xs mt-2">
              ...
              <div className="mt-3 flex w-full justify-between gap-2">
                <button className="flex-1 flex items-center justify-center gap-2 p-2 bg-gray-300 rounded-xl text-sm">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="15px"
                    viewBox="0 -960 960 960"
